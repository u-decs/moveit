    ...
    og.Controller.edit(
        {"graph_path": GRAPH_PATH, "evaluator_name": "execution"},
        {
            og.Controller.Keys.CREATE_NODES: [
                ...
                ("Context", "omni.isaac.ros2_bridge-humble.ROS2Context"),
                ("PublishJointState", "omni.isaac.ros2_bridge-humble.ROS2PublishJointState"),
                (
                    "SubscribeJointState",
                    "omni.isaac.ros2_bridge-humble.ROS2SubscribeJointState",
                ),
                (
                    "ArticulationController",
                    "omni.isaac.core_nodes.IsaacArticulationController",
                ),
                ("PublishClock", "omni.isaac.ros2_bridge-humble.ROS2PublishClock"),
                ...
                ("cameraHelperRgb", "omni.isaac.ros2_bridge-humble.ROS2CameraHelper"),
                ("cameraHelperInfo", "omni.isaac.ros2_bridge-humble.ROS2CameraHelper"),
                ("cameraHelperDepth", "omni.isaac.ros2_bridge-humble.ROS2CameraHelper"),
            ],
